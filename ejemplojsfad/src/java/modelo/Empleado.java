...
public class Empleado implements Serializable {
    ...
    @JoinColumn(name = "id_depa", referencedColumnName = "id_dep")
    @ManyToOne(optional = false)
    private Departamentos idDepa;
    ...
    public Departamentos getIdDepa() {
        return idDepa;
    }

    public void setIdDepa(Departamentos idDepa) {
        this.idDepa = idDepa;
    }
